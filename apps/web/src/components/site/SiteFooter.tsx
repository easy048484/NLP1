    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        ...
        <div className="site-footer-cols">
          ...
          <div className="site-footer-col">
            <h3>계정</h3>
            <Link to="/login" className="link-underline">로그인</Link>
            <Link to="/signup" className="link-underline">회원가입</Link>
          </div>
      ...
      <div className="site-footer-legal">
        <p>
          EZ-NEXT가 제공하는 정보는 일반적인 안내이며 법률·세무 자문이 아닙니다.
          기한·요건은 개별 사안에 따라 달라질 수 있으므로 정확한 판단은 관계
          기관과 전문가 확인이 필요합니다. 유언장 등 민감한 원문은 저장하지
          않습니다.
        </p>
        <p className="site-footer-copy">
          © {new Date().getFullYear()} EZ-NEXT · 사진 제공 Unsplash
        </p>
      </div>
    </footer>
  );
