...
## 커밋 시 AI 도구 흔적 남기지 않기

이 저장소는 커밋 메시지에 AI 코딩 도구(Claude Code, Cursor 등)의 공동저자 트레일러(`Co-Authored-By: Claude ...`)가 남지 않도록 git hook을 사용합니다.
**최초 1회, 각자 로컬 클론에서 아래 명령을 실행하세요:**
